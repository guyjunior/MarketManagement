    ...
    public class ProdutosController : Controller
    {
        ...
        public IActionResult Salvar (ProdutoDTO produtoTemporario){
            ...
            if(ModelState.IsValid){
                ...
                produto.Fornecedor = database.Fornecedores.First(fornecedor => fornecedor.Id == produtoTemporario.CategoriaID);
            ...
            public IActionResult Produto(int id){
                ...
                if(id > 0){
                    ...
                    if(produto != null){
                        ...
                        Response.StatusCode = 404; //Falha, erro 404
                        return Json(null);
                    }
                }else{
                    return Json(null);
